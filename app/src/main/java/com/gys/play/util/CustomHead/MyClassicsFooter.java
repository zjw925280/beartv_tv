...
public class MyClassicsFooter extends ClassicsAbstract<MyClassicsFooter> implements RefreshFooter {
    ...
    public MyClassicsFooter(Context context, AttributeSet attrs) {
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextNothing)) {
            ...
            mTextNothing = context.getString(com.gys.play.R.string.no_more_data);
        }
    ...
    public int onFinish(@NonNull RefreshLayout layout, boolean success) {
        ...
        if (!mNoMoreData) {
            mTitleText.setText(success ? "" : mTextFailed);
