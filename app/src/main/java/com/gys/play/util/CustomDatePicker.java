...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
    ...
    private TextView mTvMonthUnit, mTvDayUnit, mTvHourUnit, mTvMinuteUnit;
    private View mOnlyYearLeft, mOnlyYearRight;
    ...
    private void initView() {
        ...
        if (window != null) {
            ...
            window.setWindowAnimations(com.android.liba.R.style.shareDialogStyle);
        }
        ...
        mOnlyYearLeft = mPickerDialog.findViewById(R.id.only_year_view_left);
        mOnlyYearRight = mPickerDialog.findViewById(R.id.only_year_view_right);
     ...
     * 设置日期控件是否显示月和日
     */
    public void setCanShowPreciseTimeOnlyYear(boolean canShowPreciseTime) {
        if (!canShow()) return;
...
//            mOnlyYearLeft.setVisibility(View.GONE);
//            mOnlyYearRight.setVisibility(View.GONE);
//        } else {
...
//            mOnlyYearLeft.setVisibility(View.VISIBLE);
//            mOnlyYearRight.setVisibility(View.VISIBLE);
//        }
    }
