...
public class Utils {
    ...
    public static List<Icon> getIcons() {
        ...
        icons.add(new Icon(R.mipmap.icon_dianzan_yellow, R.mipmap.icon_dianzan_white, IconType.Heart));
        icons.add(new Icon(R.mipmap.icon_dianzan_yellow, R.mipmap.icon_dianzan_white, IconType.Star));
        icons.add(new Icon(R.mipmap.icon_dianzan_yellow, R.mipmap.icon_dianzan_white, IconType.Thumb));
