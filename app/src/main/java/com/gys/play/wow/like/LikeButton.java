...
public class LikeButton extends FrameLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        LayoutInflater.from(getContext()).inflate(R.layout.include_wow_like_view, this, true);
    ...
    public void onClick(View v) {
        if (!isEnabled)
            return;
        setLikeAndCallBack(!isChecked);
    }

    public void setLikeAndCallBack(Boolean status) {
        setLiked(status);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.e("1111111111 1", "onTouchEvent " + event.getAction());
