...
import com.android.liba.ui.widget.tabLayout.utils.FragmentChangeManager;
import com.android.liba.ui.widget.tabLayout.widget.UnreadMsgView;
...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mBarCornerRadius = ta.getDimension(R.styleable.SegmentTabLayout_tl_bar_corner_radius, -1);
        ta.recycle();
    }
...
//        UIHelper.showLog("AAA", "mLastP--->" + mLastP.left + "&" + mLastP.right);
//        UIHelper.showLog("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mRectDrawable.setCornerRadius(mBarCornerRadius);
    ...
    public void setBarCornerRadius(float barCornerRadius) {
        this.mBarCornerRadius = dp2px(barCornerRadius);
        invalidate();
    }
    ...
    public void showMsg(int position, int num) {
        ...
        UnreadMsgView tipView = (UnreadMsgView) tabView.findViewById(R.id.rtv_msg_tip);
        if (tipView != null) {
            tipView.show(num);
     ...
     */
    public UnreadMsgView getMsgView(int position) {
        if (position >= mTabCount) {
            position = mTabCount - 1;
        }
        View tabView = mTabsContainer.getChildAt(position);
