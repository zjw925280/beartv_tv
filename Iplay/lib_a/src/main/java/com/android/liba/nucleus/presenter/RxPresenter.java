...
import com.android.liba.nucleus.presenter.delivery.DeliverFirst;
import com.android.liba.nucleus.presenter.delivery.DeliverLatestCache;
import com.android.liba.nucleus.presenter.delivery.DeliverReplay;
...
public class RxPresenter<View> extends Presenter<View> {
    ...
    public <T> void restartableFirst(int restartableId, final Factory<Observable<T>> observableFactory,
                                     final BiConsumer<View, T> onNext, final BiConsumer<View, Throwable> onError) {
     ...
     */
    public <T> Consumer<Delivery<View, T>> split(final BiConsumer<View, T> onNext, final BiConsumer<View, Throwable> onError) {
