...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private ItemViewDelegate delegate;
    ...
    public ViewHolder(Context context, View itemView,ViewDataBinding dataBinding) {
        super(itemView);
        mContext = context;
   ...
   public void attachItemViewDelegate(ItemViewDelegate delegate)
   {
       this.delegate=delegate;
   }
   public  ItemViewDelegate getItemViewDelegate()
   {
       return delegate;
   }
    ...
    public static ViewHolder createViewHolder(Context context, ViewGroup parent, int layoutId) {
        //autolayout适配：一定要记得LayoutInflater.from(mContext).inflate使用三个参数的方法！
        View itemView = null;
        ...
        ViewHolder holder = new ViewHolder(context, itemView,dataBinding);
        return holder;
    }
    ...
    public ViewHolder setVisiblity(int viewId, boolean visible) {
        View view = getView(viewId);
