...
public class LoadingAndRetryLayout extends FrameLayout {
    ...
    public View setLoadingView(View view) {
        ...
        if (loadingView != null) {
            UIHelper.showLog(TAG, "you have already set a loading view and would be instead of this new one.");
        }
    ...
    public View setEmptyView(View view) {
        ...
        if (emptyView != null) {
            UIHelper.showLog(TAG, "you have already set a empty view and would be instead of this new one.");
        }
    ...
    public View setRetryView(View view) {
        ...
        if (retryView != null) {
            UIHelper.showLog(TAG, "you have already set a retry view and would be instead of this new one.");
        }
